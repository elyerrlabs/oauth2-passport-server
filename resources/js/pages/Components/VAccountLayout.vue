...
<template>
    <div class="min-h-screen bg-gray-50 flex">
        ...
        <aside
            :class="[
                'fixed lg:fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:transform-none lg:translate-x-0 border-r border-gray-200 flex flex-col',
