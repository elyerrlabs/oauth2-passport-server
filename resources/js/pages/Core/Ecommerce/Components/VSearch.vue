...
<template>
    <div class="hidden md:flex flex-1 mx-2 max-w-2xl relative">
        <div class="flex w-full">
            ...
            <div
                class="relative flex items-center w-full rounded-r-lg border border-gray-300 overflow-hidden"
            >
                <input
                    type="text"
    ...
    >
        <div
            class="bg-white/90 rounded-2xl shadow-xl w-full max-w-2xl p-6 animate-fadeIn"
        >
            <!-- Search Input -->
            <div class="relative">
                <i
                ...
                <input
                    ...
                    v-model="q"
                    :placeholder="__('Search products, brands and more...')"
                    class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 outline-none transition text-gray-800"
                    @keyup.enter="search"
