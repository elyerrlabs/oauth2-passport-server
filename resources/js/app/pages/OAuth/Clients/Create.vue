...
<template>
    <div class="create-client-container">
        ...
        <q-btn
            ...
            class="create-btn"
        >
            <q-tooltip>Create New OAuth Client</q-tooltip>
        </q-btn>
            ...
            <q-card class="client-card">
                ...
                <q-card-section class="dialog-header">
                    <div class="header-content">
                        <q-icon name="mdi-application-plus" size="32px" color="primary" class="header-icon" />
                        <div class="text-h5 text-weight-bold text-grey-8">Create New OAuth Client</div>
                    </div>
                ...
                <q-card-section class="dialog-content">
                    ...
                    <div class="form-section q-mb-lg">
                        <div class="input-label text-weight-medium text-grey-8 q-mb-xs">
                    ...
                    <div class="form-section q-mb-lg">
                        <div class="input-label text-weight-medium text-grey-8 q-mb-xs">
                            <q-icon name="mdi-redirect" size="18px" class="q-mr-sm" />
                            Redirect URI
                        </div>
                        <q-input
                    ...
                    <div class="form-section q-mb-lg">
                        ...
                        <div class="input-hint text-caption text-grey-6 q-mt-xs">
                            ...
                            Confidential clients can keep secrets secure (server-side applications). 
                            Uncheck for public clients (SPA, mobile apps).
                        </div>
                    </div>
                </q-card-section>
                ...
                <!-- Credentials Display -->
                <q-card-section v-if="client && Object.keys(client).length" class="credentials-section">
                    <div class="credentials-alert bg-red-1 rounded-borders q-pa-md">
                        <div class="alert-header row items-center q-mb-md">
                            <q-icon name="mdi-alert-circle" color="negative" size="24px" class="q-mr-sm" />
                            <div class="text-h6 text-negative text-weight-bold">Important Security Notice</div>
                        </div>
                        ...
                        <div class="alert-content">
                            ...
                            <div class="credentials-actions row items-center justify-between">
                                <div class="text-caption text-negative">
                                    <q-icon name="mdi-shield-key" class="q-mr-xs" />
                    ...
                    <div class="client-details q-mt-md">
                        <div class="text-subtitle2 text-weight-medium text-grey-8 q-mb-sm">Client Details:</div>
                        <div class="detail-grid">
                            ...
                            <div v-if="client.secret" class="detail-item">
                                ...
                                <span class="detail-value text-red">{{ client.secret }}</span>
                            </div>
                            <div class="detail-item">
