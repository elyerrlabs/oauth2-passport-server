    ...
    <div
        ...
        <div class="w-full lg:w-3/4 space-y-6">
            ...
            <div
                ...
                <div class="flex items-center mb-3">
                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                        <i class="mdi mdi-bullseye-arrow text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <label class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Mission') }}</label>
                </div>
            ...
            <div
                ...
                <div class="flex items-center mb-3">
                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                        <i class="mdi mdi-eye-outline text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <label class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Vision') }}</label>
                </div>
            ...
            <div
                ...
                <div class="flex items-center mb-3">
                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                        <i class="mdi mdi-heart-outline text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <label class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Values') }}</label>
                </div>
            ...
            <div
                ...
                <div class="flex items-center mb-3">
                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                        <i class="mdi mdi-text-box-outline text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <label
                        class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Short Description') }}</label>
                </div>
            ...
            <div
                ...
                <div class="flex items-center mb-3">
                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                        <i class="mdi mdi-web text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <label
                        class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Social Media & Communication') }}</label>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <input type="url" name="app[whatsapp]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-green-600 dark:focus:border-green-500 focus:ring-1 focus:ring-green-100 dark:focus:ring-green-900/20 transition-colors duration-300"
                        placeholder="WhatsApp URL o número (+51...)" value="{{ config('app.whatsapp') }}">

                    <!-- Telegram -->
                    <input type="url" name="app[telegram]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-sky-600 dark:focus:border-sky-500 focus:ring-1 focus:ring-sky-100 dark:focus:ring-sky-900/20 transition-colors duration-300"
                        placeholder="Telegram URL" value="{{ config('app.telegram') }}">

                    <!-- TikTok -->
                    <input type="url" name="app[tiktok]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-pink-600 dark:focus:border-pink-500 focus:ring-1 focus:ring-pink-100 dark:focus:ring-pink-900/20 transition-colors duration-300"
                        placeholder="TikTok URL" value="{{ config('app.tiktok') }}">

                    <!-- YouTube -->
                    <input type="url" name="app[youtube]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-red-600 dark:focus:border-red-500 focus:ring-1 focus:ring-red-100 dark:focus:ring-red-900/20 transition-colors duration-300"
                        placeholder="YouTube Channel URL" value="{{ config('app.youtube') }}">

                    <!-- Pinterest -->
                    <input type="url" name="app[pinterest]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-rose-600 dark:focus:border-rose-500 focus:ring-1 focus:ring-rose-100 dark:focus:ring-rose-900/20 transition-colors duration-300"
                        placeholder="Pinterest URL" value="{{ config('app.pinterest') }}">

                    <!-- Threads -->
                    <input type="url" name="app[threads]"
                        class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:border-gray-600 dark:focus:border-gray-500 focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 transition-colors duration-300"
                        placeholder="Threads URL" value="{{ config('app.threads') }}">
                </div>

                <small class="block mt-3 text-sm text-gray-500 dark:text-gray-400">
