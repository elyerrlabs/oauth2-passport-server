...
@section('form')
    <div
        class="flex flex-col lg:flex-row gap-8 items-start p-6 bg-slate-50 dark:bg-gray-900 rounded-2xl shadow-sm transition-colors duration-300">
        <!-- Header Section -->
        <div class="w-full lg:w-1/4 sticky top-4 space-y-4">
            <div
                class="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 text-white p-5 rounded-2xl shadow-lg">
            ...
            <div
                ...
                <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center mb-2">
                    <i class="mdi mdi-security mr-2 text-blue-600 dark:text-blue-400" aria-hidden="true"></i>
                    {{ __('Best Practices') }}
                </h3>
        ...
        <div class="w-full lg:w-3/4 space-y-6">
            ...
            <div
                ...
                <div class="flex items-center mb-6">
                    <div class="flex items-center justify-center w-10 h-10 bg-red-100 dark:bg-red-900 rounded-lg mr-3">
                        <i class="mdi mdi-speedometer text-red-600 dark:text-red-400 text-xl" aria-hidden="true"></i>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('Rate Limit Configuration') }}
                    </h3>
                </div>
            ...
            <!-- Configuration Tips -->
            <div
                class="p-5 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 transition-colors duration-300">
                <h4 class="text-md font-semibold text-blue-900 dark:text-blue-100 mb-3 flex items-center">
                    <i class="mdi mdi-lightbulb-on-outline mr-2 text-blue-600 dark:text-blue-400" aria-hidden="true"></i>
            ...
            forms.forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    if (!isValid) {
                        e.preventDefault();
                        $notify.error(
                            '{{ __('Please enter valid values for all rate limit fields') }}');
                    }
                });
            });
