    ...
    <div class="flex flex-col lg:flex-row gap-8 items-start p-6 bg-gray-50 rounded-2xl shadow-sm">
        ...
        <div class="w-full lg:w-1/4 sticky top-4">
            <div class="bg-indigo-600 text-white p-6 rounded-2xl shadow-md">
                <div class="flex items-center justify-center w-12 h-12 bg-indigo-700 rounded-xl mb-4">
            ...
            <div class="mt-4 p-4 bg-white rounded-xl shadow-sm border border-gray-200">
                <h3 class="text-sm font-semibold text-gray-800 flex items-center">
                    <i class="mdi mdi-information-outline mr-2 text-indigo-600"></i>
                    {{ __('Best Practices') }}
                </h3>
        ...
        <div class="w-full lg:w-3/4 space-y-6">
            ...
            <div
                ...
                <div class="flex items-center mb-4">
                    <div class="flex items-center justify-center w-10 h-10 bg-indigo-100 rounded-lg mr-3">
                        <i class="mdi mdi-autorenew text-indigo-600 text-xl"></i>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Enable Renewals -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Enable Renewals') }}</label>
                    ...
                    <!-- Hours Before Expiry -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Hours Before Expiry') }}</label>
                        <div class="relative">
                            <input type="number" name="billing[renew][hours_before]"
                                value="{{ config('billing.renew.hours_before') }}" min="1"
                                class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <!-- Renewal Bonus -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Renewal Bonus') }}</label>
                    ...
                    <!-- Grace Period -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Grace Period') }}</label>
                        <div class="relative">
            ...
            <div>
                <h3 class="text-lg font-semibold text-gray-900 flex items-center mb-4">
                    <i class="mdi mdi-credit-card-multiple mr-2 text-indigo-600"></i>
                    {{ __('Payment Methods') }}
                </h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center w-10 h-10 bg-indigo-100 rounded-lg mr-3">
                                    <i
                                        class="mdi mdi-{{ config('billing.methods.stripe.icon') }} text-indigo-600 text-xl"></i>
                                </div>
                                <h4 class="text-md font-semibold text-gray-900">{{ __('Stripe Settings') }}</h4>
                            </div>
                            <span
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('Display Name') }}</label>
                            ...
                            <!-- Icon -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Icon Class') }}</label>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200">
                            <h5 class="text-sm font-semibold text-gray-800 mb-3 flex items-center">
                                <i class="mdi mdi-key-outline mr-2 text-yellow-500"></i>
                                {{ __('API Credentials') }}
                            </h5>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('Secret Key') }}</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('Public Key') }}</label>
                                ...
                                <div class="md:col-span-2">
                                    <label
                                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('Webhook Secret') }}</label>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center w-10 h-10 bg-indigo-100 rounded-lg mr-3">
                                    <i
                                        class="mdi mdi-{{ config('billing.methods.offline.icon') }} text-indigo-600 text-xl"></i>
                                </div>
                                <h4 class="text-md font-semibold text-gray-900">{{ __('Offline Payment Settings') }}</h4>
                            </div>
                            <span
