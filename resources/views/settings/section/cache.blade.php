            ...
            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="cache-driver" name="cache[default]"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="cache[expires]"
                                class="w-full pl-16 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="cache[prefix]"
                                class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300"
                                value="{{ config('cache.prefix') }}" placeholder="laravel_cache">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="mdi mdi-pound text-gray-500 dark:text-gray-400"></i>
                            </div>
                        </div>
                        <small class="block mt-2 text-sm text-gray-500 dark:text-gray-400">
                            <i class="mdi mdi-information-outline mr-1"></i>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div data-driver="database"
                        class="driver-fields p-5 bg-gray-50 dark:bg-gray-700 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 hidden transition-colors duration-300">
                        <h4 class="text-md font-semibold text-gray-800 dark:text-gray-200 mb-4 flex items-center">
                            <i class="mdi mdi-database mr-2 text-indigo-600 dark:text-indigo-400"></i>
                            {{ __('Database Cache Configuration') }}
                        </h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Connection') }}</label>
                                <div class="relative">
                                    <input type="text" name="cache[stores][database][connection]"
                                        class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300"
                                        value="{{ config('cache.stores.database.connection') }}" placeholder="mysql">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <i class="mdi mdi-connection text-gray-500 dark:text-gray-400"></i>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Table') }}</label>
                                <div class="relative">
                                    <input type="text" name="cache[stores][database][table]"
                                        class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300"
                                        value="{{ config('cache.stores.database.table') }}" placeholder="cache">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <i class="mdi mdi-table text-gray-500 dark:text-gray-400"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-driver="redis"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Lock Connection') }}</label>
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <i class="mdi mdi-lock-outline text-gray-500 dark:text-gray-400"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-driver="memcached"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Persistent ID') }}</label>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('SASL Username') }}</label>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('SASL Password') }}</label>
                                <input type="password" name="cache[stores][memcached][sasl][password]"
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-300"
                                    value="{{ config('cache.stores.memcached.sasl.password') }}">
                            </div>
                            <div class="md:col-span-2">
                                <h5 class="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3 mt-4">
                                    {{ __('Server Configuration') }}</h5>
                    ...
                    <div data-driver="dynamodb"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('AWS Key') }}</label>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('AWS Secret') }}</label>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Region') }}</label>
                            ...
                            <div class="md:col-span-2">
                                <label
                                    class="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">{{ __('Endpoint (Optional)') }}</label>
