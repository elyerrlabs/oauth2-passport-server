                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-1">No pages found
                                        </h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Try adjusting your search
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    Are you sure you want to delete <strong id="deletePageName"></strong>? This action
                                    cannot be undone.
                                </p>
                            </div>
                        </div>
