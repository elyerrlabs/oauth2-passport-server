...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-2 col-12">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link font-bold" href="{{ route('user.dashboard') }}">{{ __('Dashboard') }}</a>
                    </li>
        ...
        <div class="row">
            ...
            ?>
                    ...
                    <a href="?l={{ \Illuminate\Support\Facades\Crypt::encryptString($file) }}" class="list-group-item @if ($current_file == $file) llv-active @endif">
                        {{$file}}
                    </a>
                    @endforeach
                </div>
