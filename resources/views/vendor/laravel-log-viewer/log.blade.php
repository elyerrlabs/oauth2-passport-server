...
<head>
    ...
    <title>{{ __('Laravel log viewer') }}</title>
    <link nonce="{{ $nonce }}" rel="stylesheet"
        href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css"
        integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link nonce="{{ $nonce }}" rel="stylesheet" type="text/css"
    ...
    */
        ...
        [data-theme="dark"] .table th,[data-theme="dark"] .table thead th {
            border-color: #616161;
        }
...
<body>
    <div class="container-fluid">
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4 col-12">
                <a class="navbar-brand" href="{{ route('user.admin.dashboard') }}">
                    {{ __('Admin Dashboard') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('user.dashboard') }}">{{ __('User Dashboard') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.settings.general') }}">{{ __('Settings') }}</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="col sidebar mb-3">
                <h1><i class="fa fa-calendar" aria-hidden="true"></i> {{ __('Laravel Log Viewer') }}</h1>
                            ...
                            @foreach ($logs as $key => $log)
                                <tr data-display="stack{{ $key }}">
                                    ...
                                    <td class="text">
                                        ...
                                        @endif
                                        @if ($log['stack'])
                                            <div class="stack hidden" id="stack{{ $key }}">
                                                {{ trim($log['stack']) }}
                                            </div>
                                        @endif
    ...
    <script nonce="{{ $nonce }}" src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
        integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous">
    </script>
    <script nonce="{{ $nonce }}" src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"
