        ...
        <form method="POST" action="{{ route('admin.pages.update', $page->id) }}" class="space-y-6">
            ...
            <section
                ...
                <div class="grid gap-6 px-6 py-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="is_published" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ __('Is published') }}
                        </label>
                    ...
                    <div>
                        <label for="is_draft" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ __('Is draft') }}
                        </label>
