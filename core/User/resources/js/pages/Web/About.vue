                ...
                <div v-if="filtered_apps.length" class="mb-8">
                    ...
                    >
                        <a
                            ...
                            :key="app.id"
                            :href="app.route"
                            class="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-md transition-all duration-200 p-3 text-center"
                        >
                            <div
                ...
                <div v-if="filtered_admin.length" class="mb-8">
                    ...
                    >
                        <a
                            ...
                            :key="admin.id"
                            :href="admin.route"
                            class="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-md transition-all duration-200 p-3 text-center"
                        >
                            <div
                ...
                <div v-if="filtered_settings.length" class="mb-8">
                    ...
                    >
                        <a
                            ...
                            :key="setting.id"
                            :href="setting.route"
                            class="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-md transition-all duration-200 p-3 flex items-center gap-3"
                        >
                            <div
