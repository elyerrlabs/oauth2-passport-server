        ...
        <div class="mx-auto max-w-5xl space-y-6 px-4 py-4 sm:px-6">
            ...
            >
                ...
                >
                    ...
                    >
                        <div class="max-w-2xl">
                            ...
                            >
                                <i
                                    class="mdi mdi-shield-key-outline text-2xl"
                                ></i>
                            </div>
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div
                        class="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(280px,1fr)]"
                    >
                        <div
                        ...
                        >
                            <!-- 2FA NOT ENABLED -->
                            <div
                                v-if="!isTwoFactorEnabled && !isSetupInProgress"
                            >
                                <h3
                            ...
                            <div v-else>
                                ...
                                >
                                    ...
                                    <p
                                        class="text-sm mb-4 text-red-600 dark:text-red-300"
                                    >
                                        {{
                                            __(
                        ...
                        <aside class="space-y-4">
                            ...
                            >
                                ...
                                >
                                    <li class="flex gap-3">
                                        <span
                                            class="mt-0.5 h-2 w-2 rounded-full bg-blue-500"
                                        ></span>
                                        <span>{{
                                            __(
                            ...
                            >
                                <div class="mb-3 flex items-center gap-3">
                                    ...
                                    >
                                        <i
                                            class="mdi mdi-lock-check-outline text-xl text-emerald-600 dark:text-emerald-400"
                                        ></i>
                                    </div>
                                    <h2
                                        class="text-base font-semibold text-emerald-800 dark:text-emerald-300"
                                    >
                                        {{ __("Security Tips") }}
                                    </h2>
                                </div>
                                ...
                                <ul
                                    class="space-y-3 text-sm text-emerald-700 dark:text-emerald-300"
                                >
                                    <li>
                                        {{
                                            __(
                                                "Do not share your recovery codes.",
                                            )
                                        }}
                                    </li>
                                    <li>
                                        {{
                                            __(
                                                "Use a trusted authenticator app on a device you control.",
                                            )
                                        }}
                                    </li>
                                    <li>
                                        {{
                                            __(
                                                "Regenerate recovery codes if you think they were exposed.",
                                            )
                                        }}
                                    </li>
                                </ul>
