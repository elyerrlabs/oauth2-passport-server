...
class UserTransformer extends TransformerAbstract
{
    ...
    public function transform(User $user)
    {
        ...
        return [
            ...
            'scopes' => fractal($user->userScopes, UserScopeTransformer::class)->toArray()['data'] ?? [],
            'links' => [
                ...
                'edit' => route('user.admin.users.edit', ['user' => $user->id]),
                'update' => route('user.admin.users.update', ['user' => $user->id]),
                // 'destroy' => route('api.user.admin.users.update', ['user' => $user->id]),
                'disabled' => route('user.admin.users.disabled', ['user' => $user->id]),
                'enabled' => route('user.admin.users.enabled', ['user' => $user->id]),
