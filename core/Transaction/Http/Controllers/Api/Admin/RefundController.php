...
class RefundController extends ApiController
{
    ...
    {
        parent::__construct();
        $this->middleware('scope:administrator:refunds:full, administrator:refunds:view')->only('index', 'show');
        $this->middleware('scope:administrator:refunds:full, administrator:refunds:update')->only('update');
        $this->middleware('scope:administrator:refunds:full, administrator:refunds:assign')->only('assignTo', 'listUsersForRefundAssignment');
    }
