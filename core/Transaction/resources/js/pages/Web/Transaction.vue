...
<template>
    <v-account-layout>
            ...
            >
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <div
                            class="w-2 h-8 bg-linear-to-b from-blue-500 to-blue-600 rounded-full"
                        ></div>
                        <h1
                            class="text-md md:text-lg lg:text-2xl font-bold bg-linear-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-600 bg-clip-text text-transparent"
                        >
        ...
        >
            <!-- Table Header -->
            <div
                class="px-6 py-4 bg-linear-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 border-b border-gray-200 dark:border-gray-600"
            >
